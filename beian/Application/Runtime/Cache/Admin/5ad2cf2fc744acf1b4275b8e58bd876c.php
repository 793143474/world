...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">新闻资讯</h2>
            <a class="fr top_rt_btn" href="<?php echo U(news_list);?>">返回新闻列表</a>
        </div>
        <section>
            <ul class="ulColumn2">
                <form action="news_detail" method="post" enctype="multipart/form-data">
                    <li>
                        <span class="item_name" style="width:120px;">新闻标题：</span>
                        <input type="text" class="textbox textbox_295" placeholder="新闻标题..." name="ntitle"/>
                    ...
                    <li>
                        ...
                        <select class="select" name="style">
                            <option type="select" value="0">新闻</option>
                            <option value="1">观点</option>
                    ...
                    <li>
                        ...
                        <textarea class="textbox" name="abstract" placeholder="摘要..." style="width: 295px;height: 80px"></textarea>
                        <?php if(!empty($_SESSION['info2'])): echo (session('info2')); endif; ?>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">作者：</span>
                        <input class="textbox" type="text" name="auther">
                        <?php if(!empty($_SESSION['info3'])): echo (session('info3')); endif; ?>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">来源：</span>
                        <input class="textbox" type="text" name="source">
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">注释：</span>
                        <textarea class="textbox" type="text" name="zhushi" style="width:200px;"></textarea>
                    </li>

                    <li>
                        <span class="item_name" style="width:120px;">关键字：</span>
                        <textarea class="textbox" type="text" name="tjgjz" style="width:200px;"></textarea>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">推荐：</span>
                        <label class="single_selection"><input type="checkbox" name="tuijian"/>是否首页推荐</label>
                    </li>

                    <li>
                        <span class="item_name" style="width:120px;">Banner图：</span>
                    ...
                    <li>
                        ...
                        <textarea id="editor" type="text/plain" style="width:1024px;height:500px;margin-left:120px;margin-top:0;" name="newscontent"></textarea>
                    </li>
                    <li>
