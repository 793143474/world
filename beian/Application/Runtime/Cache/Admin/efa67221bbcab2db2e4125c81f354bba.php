        ...
        <table class="table">
            <tr>
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="center"><?php echo ($vo['moblie']); ?></td>
                        <td class="center"><?php echo ($vo['truename']); ?></td>
                        <td class="center"><?php echo ($vo['time']); ?></td>
                        <td class="center">
                         <!--   <a href="user_detail.html" title="编辑" class="link_icon">&#101;</a>-->
                        <a href="<?php echo U('user/user_list',array('uid'=>$vo['uid']));?>" title="删除" name="delete" class="link_icon">&#100;</a>
                        </td>
