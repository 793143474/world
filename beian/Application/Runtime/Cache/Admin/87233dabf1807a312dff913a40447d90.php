...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            ...
            <a class="fr top_rt_btn" href="<?php echo U(artist_list);?>">返回艺术家列表</a>
        </div>
        <section>
            <ul class="ulColumn2">
                <form action="<?php echo U('artist/artist_detail');?>" method="post" enctype="multipart/form-data">
                    ...
                    <li>
                        ...
                        <input type="text" class="textbox textbox_295" placeholder="艺术家名称..." name="yname"/>
                    </li>
                    <!--图片上传-->
                    <li>
                        <div id="preview"></div>
                    ...
                    <li>
                        ...
                        <input type="text" class="textbox textbox_295" placeholder="艺术家职位..." name="position"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">已征集件数：</span>
                        <input type="text" class="textbox textbox_295" placeholder="已征集件数..." name="collect" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">鉴证备案件数：</span>
                        <input type="text" class="textbox textbox_295" placeholder="鉴证备案件数..." name="appraisal" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">Cars认证件数：</span>
                        <input type="text" class="textbox textbox_295" placeholder="Cars认证件数..." name="carsart" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">在线认证件数：</span>
                        <input type="text" class="textbox textbox_295" placeholder="在线认证件数..." name="online" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">艺术家简介：</span>
                        <textarea class="textbox" placeholder="艺术家简介..." style="width: 295px;height: 80px" name="summary"></textarea>
                    </li>
                    <li>
