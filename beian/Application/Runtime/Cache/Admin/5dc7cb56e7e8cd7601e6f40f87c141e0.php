...
<section class="rt_wrap content mCustomScrollbar">
    ...
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl"><a href="<?php echo U('news/news_list');?>">新闻资讯列表</a></h2>
            <a href="<?php echo U('news_detail');?>" class="fr top_rt_btn add_icon">添加新闻</a>
        </div>
        <section class="mtb">
        ...
        <table class="table">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td class="center"><input type="checkbox" name="nid[]" value="<?php echo ($vo['nid']); ?>" /></td>
                <td class="center"><?php echo ($vo['ntitle']); ?></td>
                <td class="center"><?php echo ($vo['newsdate']); ?></td>
                <td class="center"><?php echo ($vo['auther']); ?></td>
                <td class="center"><?php echo ($vo['source']); ?></td>
                <td class="center">
                    <a href="<?php echo U('news/edit',array('nid'=>$vo['nid']));?>" title="编辑" class="link_icon">&#101;</a>
                    <a href="<?php echo U('news/news_list',array('nid'=>$vo['nid']));?>" title="删除" class="link_icon" onclick="return confirm('您确定要删除？')">&#100;</a>
                </td>
