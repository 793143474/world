...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">添加艺术家</h2>
            <a class="fr top_rt_btn">返回产品列表</a>
        </div>
        <section>
            <ul class="ulColumn2">
                <form action="<?php echo U('artist/artist_detail');?>" method="post" enctype="multipart/form-data">
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" class="textbox textbox_295" placeholder="艺术家名称..." name="yname" value="<?php echo ($data['yname']); ?>"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">职位：</span>
                        <input type="text" class="textbox textbox_295" placeholder="艺术家职位..." name="position" value="<?php echo ($data['position']); ?>"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">征集件数：</span>
                        <input type="text" class="textbox textbox_295" placeholder="征集件数..." name="collect" value="<?php echo ($data['collect']); ?>" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">备案作品数：</span>
                        <input type="text" class="textbox textbox_295" placeholder="备案作品数..." name="appraisal" value="<?php echo ($data['appraisal']); ?>" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">Cars认证作品数：</span>
                        <input type="text" class="textbox textbox_295" placeholder="Cars认证作品数..." name="carsart" value="<?php echo ($data['carsart']); ?>" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">在线认证作品：</span>
                        <input type="text" class="textbox textbox_295" placeholder="在线认证作品..." name="online" value="<?php echo ($data['online']); ?>" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">艺术家简介：</span>
                        <textarea class="textbox" placeholder="简介..." style="width: 295px;height: 80px" name="summary"><?php echo ($data['summary']); ?></textarea>
                    </li>
                    <li>
