...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <div name="select">
            ...
            <a href="<?php echo U('artist/artist_exone');?>"><input type="button" value="已通过" class="group_btn" style="color: orange"/></a>
            <a href="<?php echo U('artist/artist_extwo');?>"><input type="button" value="未通过" class="group_btn" /></a>
        </div>
