...
$(".more").click(function(){
	$(this).hide();
	$(this).next(".updown").show();
	$(this).prev(".artist_p").addClass("artist_active");
})
$(".updown").click(function(){
	$(this).hide();
	$(this).prev(".more").show();
	$(this).prev().prev(".artist_p").removeClass("artist_active");
})
...
$(function(){
	...
	$(".works_sort span").click(function(){
		...
		RetSelecteds();
		Ajxs();
		alert(RetSelecteds().split(",")[6])
	});
	$(".tiem_class input").blur(function(){
		RetSelecteds();
		Ajxs();
	});
	$("#select_k1").blur(function(){
		RetSelecteds();
		Ajxs();
	});
	RetSelecteds();
...
//					list+="<li><div class='auction-img'><a href='"+data[i].url+"'><img src="+data[i].pictures+"></a></div>";
