...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <div name="select">
            <a href="<?php echo U('product/product_list');?>"><input type="button" value="未鉴证" class="group_btn" /></a>
            <a href="<?php echo U('product/product_listone');?>"><input type="button" value="鉴证真品" class="group_btn" style="color: orange"/></a>
