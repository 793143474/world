...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">账号列表</h2>
            <a href="<?php echo U('member/member_detail');?>" class="fr top_rt_btn add_icon">添加账号</a>
        </div>
        ...
        <table class="table">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td class="center">
                        <input type="checkbox" class="textbox textbox_295" name="style"/>
                    </td>
                    <td class="center"><?php echo ($vo['name']); ?></td>
                    <td class="center"><?php echo ($vo['time']); ?></td>
                    <td class="center">
                        <a href="<?php echo U('member/member_list',array('aid'=>$vo['aid']));?>" title="删除" name="delete" class="link_icon">&#100;</a>
                    </td>
