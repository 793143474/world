...
<script src="/beian/Public/admin/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="/beian/Public/admin/js/head_banner.js"></script>
    <script src="/beian/Public/admin/css/head_banner.css"></script>
<script>
	(function($){
...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <section>
            <ul class="ulColumn2">
                <form>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = array_slice($data,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <span class="item_name" style="width:120px ;">公司名：</span>
                        <input class="textbox" type="text" value="<?php echo ($vo['name']); ?>" style="width: 160px" onfocus="this.blur()"/>
                        <input type="hidden" value="<?php echo ($vo['id']); ?>"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">添加logo图：</span>
                        <img src="/beian/Public/Upload/<?php echo ($vo['logo']); ?>" style="width: 242px;height: 105px;border: 1px solid #b0b0b0">
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">水印：</span>
                        <img src="/beian/Public/Upload/<?php echo ($vo['shuiyin']); ?>" style="width: 242px;height: 100px;border: 1px solid #b0b0b0">
                    </li>
                        <li>
                            <span class="item_name" style="width:120px;"></span>
                            <a href="<?php echo U('index/index',array('id'=>$vo['id']));?>" title="删除" class="link_btn">删除</a>
