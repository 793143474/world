...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">图集列表</h2>
            <a href="<?php echo U('atlas/atlas_detail');?>" class="fr top_rt_btn add_icon">添加图集</a>
        </div>
        <section class="mtb">
            <form action="atlas_list" method="post" enctype="multipart/form-data">
                <select class="select" name="select" >
                    <option value="1">图集标题</option>
        ...
        <table class="table">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td class="center"><a herf="/beian/Public/Upload/<?php echo ($vo['banner']); ?>" target=_blank"><img src="/beian/Public/Upload/<?php echo ($vo['banner']); ?>" width="50" height="50"/></a></td>
                    ...
                    <td class="center">
                        ...
                        <a href="<?php echo U('atlas/edit',array('id'=>$vo['id']));?>" title="编辑" class="link_icon">&#101;</a>
                        <a href="<?php echo U('atlas/atlas_list',array('id'=>$vo['id']));?>" title="删除" class="link_icon" onclick="return confirm('您确定要删除？')">&#100;</a>
                    </td>
