...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <section class="mtb">
            <form action="zuzhi_one" method="post" enctype="multipart/form-data">
        ...
        <div name="select">
            ...
            <a href="<?php echo U('zuzhi/zuzhi_one');?>"><input type="button" value="审核通过" class="group_btn" style="color: orange"/></a>
            <a href="<?php echo U('zuzhi/zuzhi_two');?>"><input type="button" value="初审失败" class="group_btn" /></a>
        </div>
