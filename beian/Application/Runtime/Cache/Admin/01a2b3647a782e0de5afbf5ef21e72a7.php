...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <div name="select">
            ...
            <a href="<?php echo U('union/union_one');?>"><input type="button" value="已通过" class="group_btn" /></a>
            <a href="<?php echo U('union/union_two');?>"><input type="button" value="未通过" class="group_btn" style="color: orange"/></a>
        </div>
