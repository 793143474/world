...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">添加账号</h2>
            <a class="fr top_rt_btn" href="<?php echo U('member/member_list');?>">返回账号列表</a>
        </div>
        <section>
            <ul class="ulColumn2">
                <form action="<?php echo U('member/member_detail');?>" method="post" enctype="multipart/form-data">
                    <li>
                        <span class="item_name" style="width:120px;">账号：</span>
                        <input type="text" class="textbox textbox_295" placeholder="账号..." name="name"/>
                        <input type="hidden" name="time"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">密码：</span>
                        <input type="password" class="textbox textbox_295" placeholder="密码..." name="password"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">确认密码：</span>
                        <input type="password" class="textbox textbox_295" placeholder="确认密码..." name="repwd"/>
                    </li>
                    <li>
