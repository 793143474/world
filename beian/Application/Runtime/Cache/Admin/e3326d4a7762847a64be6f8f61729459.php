...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <section class="mtb">
            <form action="zuzhi_two" method="post" enctype="multipart/form-data">
        ...
        <div name="select">
            <a href="<?php echo U('zuzhi/zuzhi');?>"><input type="button" value="新增机构" class="group_btn" /></a>
            <a href="<?php echo U('zuzhi/zuzhi_one');?>"><input type="button" value="审核通过" class="group_btn" /></a>
            <a href="<?php echo U('zuzhi/zuzhi_two');?>"><input type="button" value="初审失败" class="group_btn" style="color: orange"/></a>
        </div>
        <form name="myform" id="myform" method="post">
            <table class="table">
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="center"><?php echo ($vo['mechanism_name']); ?></td>
                        <td class="center"><?php echo ($vo['mechanism_faren']); ?></td>
                        <td class="center"><?php echo ($vo['mechanism_contacts']); ?></td>
                        <td class="center"><?php echo ($vo['mobile']); ?></td>
                        <td class="center"><?php echo ($vo['mechanism_address']); ?></td>
                        <td class="center"><?php echo ($vo['time']); ?></td>
                        <td class="center">
                            <a href="<?php echo U('zuzhi/zuzhi_edit',array('id'=>$vo['id']));?>" title="编辑" class="link_icon">&#101;</a>
                            <a href="<?php echo U('zuzhi/zuzhi',array('id'=>$vo['id']));?>" title="删除" name="delete" class="link_icon" onclick="return confirm('您确定要删除？')">&#100;</a>
                        </td>
