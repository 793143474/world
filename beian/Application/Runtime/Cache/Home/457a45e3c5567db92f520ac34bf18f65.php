...
<div class="mian_Box cl">
	...
	<div class="list_nav">
		<form action="Special_list" method="post" enctype="multipart/form-data" >
			<strong>排序</strong>
			<div class="sort_one">
				<span class="active">
	...
	<div class="special_list">
		<ul>
			...
			<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
					<a href="<?php echo U('special/Special',array('aid'=>$v['aid']));?>">
						<div class="special_Pic">
							<img src="/beian/Public/Upload/<?php echo ($v['banner_pictures']); ?>">
						</div>
