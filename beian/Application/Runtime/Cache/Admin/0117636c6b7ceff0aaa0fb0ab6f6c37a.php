...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl"><a href="<?php echo U(artist/artist_list);?>"></a>艺术家审核列表</h2>
        </div>
        <section class="mtb">
        ...
        <div name="select">
            <a href="<?php echo U('artist/artist_ex');?>"><input type="button" value="未审核" class="group_btn" /></a>
            <a href="<?php echo U('artist/artist_exone');?>"><input type="button" value="已通过" class="group_btn" /></a>
            <a href="<?php echo U('artist/artist_extwo');?>"><input type="button" value="未通过" class="group_btn" style="color: orange"/></a>
        </div>
        <form name="myform" id="myform" method="post">
            <table class="table">
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td class="center"><input type="checkbox" name="yid[]" value="<?php echo ($vo['yid']); ?>" /></td>
                        <td class="center"><img src="/beian/Public/Upload/<?php echo ($vo['aphoto']); ?>" width="50" height="50"/></td>
                        <td class="center"><?php echo ($vo['yname']); ?></td>
                        <td class="center"><?php echo ($vo['collect']); ?></td>
                        <td class="center"><?php echo ($vo['appraisal']); ?></td>
                        <td class="center"><?php echo ($vo['carsart']); ?></td>
                        <td class="center"><?php echo ($vo['online']); ?></td>
                        <td class="center">
                            <a href="<?php echo U('artist/artist_edit',array('yid'=>$vo['yid']));?>" title="编辑" class="link_icon">&#101;</a>
                            <a href="<?php echo U('artist/artist_ex',array('yid'=>$vo['yid']));?>" title="删除" name="delete" class="link_icon" onclick="return confirm('您确定要删除？')">&#100;</a>
                        </td>
