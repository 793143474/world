...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <div name="select">
            ...
            <a href="<?php echo U('product/songjian_one');?>"><input type="button" value="通过初审" class="group_btn" style="color: orange"/></a>
            <a href="<?php echo U('product/songjian_two');?>"><input type="button" value="初审失败" class="group_btn" /></a>
        </div>
