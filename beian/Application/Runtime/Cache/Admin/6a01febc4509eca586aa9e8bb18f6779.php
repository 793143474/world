...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <section>
            <ul class="ulColumn2">
                <form action="<?php echo U('edit/edit');?>" method="post">
                <li>
                    <span class="item_name"  style="width:120px;">作品名称：</span>
                    <input name="gid" type="hidden"  value="<?php echo ($data['gid']); ?>"/>
                    <input type="text" name="name" class="textbox textbox_295" placeholder="作品名称..." value="<?php echo ($data['name']); ?>"/>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">艺术家：</span>
                    <input type="text" name="yname" class="textbox" placeholder="艺术家名称..." value="<?php echo ($data['yname']); ?>"/>
                </li>
                <li>
                    <span class="item_name" style="width:120px;">编号：</span>
                    <input type="text" name="bianhao" class="textbox" placeholder="作品编号..." value="<?php echo ($data['bianhao']); ?>"/>
                </li>
                <li>
                ...
                <li>
                    ...
                    <input type="text" name="cztime" value="<?php echo ($data['cztime']); ?>">
                </li>
                <li>
                    <span class="item_name" style="width:120px;">鉴定时间：</span>
                    <input type="text" name="jdtime" value="<?php echo ($data['jdtime']); ?>" >
                </li>
                <li>
                ...
                <li>
                    ...
                    <textarea id="editor" type="text/plain"  name="editor" style="width:1024px;height:500px;margin-left:120px;margin-top:0;"><?php echo ($data['editor']); ?></textarea>
                </li>
                <li>
