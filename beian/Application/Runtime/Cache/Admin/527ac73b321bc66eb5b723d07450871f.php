...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl"><a href="<?php echo U('product/product_list');?>">作品列表</a></h2>
      <!-- <a href="<?php echo U('product/');?>" class="fr top_rt_btn add_icon">添加作品</a>-->
      </div>
         <section class="mtb">
     ...
     <div name="select">
         <a href="<?php echo U('product/product_list');?>"><input type="button" value="未鉴证" class="group_btn" style="color: orange"/></a>
         <a href="<?php echo U('product/product_listone');?>"><input type="button" value="鉴证真品" class="group_btn" /></a>
         <a href="<?php echo U('product/product_listtwo');?>"><input type="button" value="鉴证次品" class="group_btn" /></a>
     </div>
     <form name="myform" id="myform" method="post">
      <table class="table">
       ...
       <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               <td class="center"><input type="checkbox" name="gid[]" value="<?php echo ($vo['gid']); ?>" /></td>
                <td class="center"><img src="/beian/Public/Upload/<?php echo ($vo['banner']); ?>" width="50" height="50"/></td>
                <td class="center"><?php echo ($vo['name']); ?></td>
                <td class="center"><?php echo ($vo['yname']); ?></td>
                <td class="center"><?php echo ($vo['bianhao']); ?></td>
                <td class="center"><?php echo ($vo['cztime']); ?></td>
                <td class="center"><a title="是" class="link_icon">&#89;</a></td>
                <td class="center">
                    <a href="<?php echo U('product/product_detail',array('aid'=>$vo['aid']));?>" title="编辑" class="link_icon">&#101;</a>
                    <a href="<?php echo U('product/product_list',array('aid'=>$vo['aid']));?>" title="删除" name="delete" class="link_icon" onclick="return confirm('您确定要删除？')">&#100;</a>
                </td>
