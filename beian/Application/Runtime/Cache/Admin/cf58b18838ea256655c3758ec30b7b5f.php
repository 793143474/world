...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl"><a href="<?php echo U('artist_list');?>">艺术家列表</a></h2>
            <a href="<?php echo U('artist/artist_detail');?>" class="fr top_rt_btn add_icon">添加艺术家</a>
        </div>
        <section class="mtb">
        ...
        <table class="table">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="center">
                        <a href="<?php echo U('artist/edit',array('yid'=>$vo['yid']));?>" title="编辑" class="link_icon">&#101;</a>
                        <a href="<?php echo U('artist/artist_list',array('yid'=>$vo['yid']));?>" title="删除" class="link_icon">&#100;</a>
                    </td>
