...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <section>
            <ul class="ulColumn2">
                <form action="<?php echo U('news/problem_edit');?>" method="post">
                    <li>
                        <span class="item_name"  style="width:120px;">问题标题：</span>
                        <input name="id" type="hidden"  value="<?php echo ($data['id']); ?>"/>
                        <input type="text" name="title" class="textbox textbox_295" value="<?php echo ($data['title']); ?>"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">问题摘要：</span>
                        <input type="text" name="zhanyao" class="textbox" value="<?php echo ($data['zhanyao']); ?>"/>
                    </li>
                    <li>
                        <span class="item_name"  style="width:120px;">问题来源：</span>
                        <input type="text" name="laiyuan" value="<?php echo ($data['laiyuan']); ?>" >
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">责任编辑：</span>
                        <input type="text" name="edit" value="<?php echo ($data['edit']); ?>" >
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">推荐关键字：</span>
                        <input type="text" name="guanjian" value="<?php echo ($data['guanjian']); ?>" >
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">问题内容：</span>
                        <textarea type="text/plain" id="editor" name="neirong" style="width:1024px;height:500px;margin-left:120px;margin-top:0;"><?php echo ($data['neirong']); ?></textarea>
                    </li>
                    <li>
