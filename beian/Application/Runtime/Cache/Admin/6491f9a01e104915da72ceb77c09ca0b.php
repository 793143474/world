...
<section class="rt_wrap content mCustomScrollbar">
    ...
    <div name="select">
        <a href="<?php echo U('special/special_list');?>"><input type="button" value="全部专场" class="group_btn" /></a>
        <a href="<?php echo U('special/special_listone');?>"><input type="button" value="未开始专场" class="group_btn" style="color: orange"/></a>
        ...
        <table class="table">
            ...
            <?php if(is_array($array)): $i = 0; $__LIST__ = $array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="center">
                        ...
                        <a href="<?php echo U('special/special_listone',array('aid'=>$vo['aid']));?>" title="删除" name="delete" class="link_icon" onclick="return confirm('您确定要删除？')">&#100;</a>
                    </td>
