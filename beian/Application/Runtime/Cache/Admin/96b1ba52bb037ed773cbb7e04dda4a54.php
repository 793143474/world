...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <section class="mtb">
            <form action="union_one" method="post" enctype="multipart/form-data">
        ...
        <div name="select">
            <a href="<?php echo U('union/union');?>"><input type="button" value="未审核" class="group_btn" /></a>
            <a href="<?php echo U('union/union_one');?>"><input type="button" value="已通过" class="group_btn" style="color: orange"/></a>
            <a href="<?php echo U('union/union_two');?>"><input type="button" value="未通过" class="group_btn" /></a>
        </div>
        <form name="myform" id="myform" method="post">
            <table class="table">
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="center"><img src="/beian/Public/Upload/<?php echo ($vo['picture']); ?>" width="50" height="50"/></td>
                        <td class="center"><?php echo ($vo['contacts_name']); ?></td>
                        <td class="center"><?php echo ($vo['contacts_tele']); ?></td>
                        <td class="center"><?php echo ($vo['address']); ?></td>
                        <td class="center"><?php echo ($vo['time']); ?></td>
                        <td class="center"><?php echo ($vo['remarks']); ?></td>
                        <td class="center">
                            <a href="<?php echo U('union/union_edit',array('id'=>$vo['id']));?>" title="编辑" class="link_icon">&#101;</a>
                            <a href="<?php echo U('union/union',array('id'=>$vo['id']));?>" title="删除" name="delete" class="link_icon" onclick="return confirm('您确定要删除？')">&#100;</a>
                        </td>
