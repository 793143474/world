    ...
    <div class="rt_content">
        ...
        <section>
              ...
              <form action="material" method="post" enctype="multipart/form-data" >
                    <li>
                        ...
                        <select class="select" name="category">
                            ...
                            <?php if(is_array($aaa)): $i = 0; $__LIST__ = $aaa;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['cid']); ?>"><?php echo ($vo['material']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
            ...
            <table class="table">
                ...
                <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form action="product_material" method="post" >
                    <tr>
                        <input type="hidden" name="cid" class="textbox" value="<?php echo ($vo['cid']); ?>"/>
                        <td><?php echo ($vo['h']); echo ($vo['material']); ?></td>
