...
<head>
    ...
    <link href="/beian/Public/FileUpload/css/iconfont.css" rel="stylesheet" type="text/css"/>
    <link href="/beian/Public/FileUpload/css/fileUpload.css" rel="stylesheet" type="text/css">
    <script>
        (function($){
...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">添加图集</h2>
            <a class="fr top_rt_btn" href="<?php echo U('atlas/atlas_list');?>">返回图集列表</a>
        </div>
        <section>
            <ul class="ulColumn2">
                <form action="<?php echo U('atlas/atlas_detail');?>" method="post" enctype="multipart/form-data">
                    <li>
...
<script type="text/javascript" src="/beian/Public/FileUpload/js/jquery-2.1.3.min.js"></script>
<script type="text/javascript" src="/beian/Public/FileUpload/js/fileUpload.js"></script>
