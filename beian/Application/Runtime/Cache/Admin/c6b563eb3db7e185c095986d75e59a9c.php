...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <section>
            <ul class="ulColumn2">
                <form action="<?php echo U('news/edit');?>" method="post">
                    <li>
                        <span class="item_name"  style="width:120px;">新闻标题：</span>
                        <input name="nid" type="hidden"  value="<?php echo ($data['nid']); ?>"/>
                        <input type="text" name="ntitle" class="textbox textbox_295" value="<?php echo ($data['ntitle']); ?>"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">新闻摘要：</span>
                        <input type="text" name="abstract" class="textbox" value="<?php echo ($data['abstract']); ?>"/>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" name="auther" value="<?php echo ($data['auther']); ?>" >
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" name="zhushi" value="<?php echo ($data['zhushi']); ?>" >
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">推荐关键字：</span>
                        <input type="text" name="tjgjz" value="<?php echo ($data['tjgjz']); ?>" >
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <label class="uploadImg">
                            <img href="/beian/Public/upload/<?php echo ($data['banner']); ?>"/>
                    ...
                    <li>
                        ...
                        <textarea type="text/plain" id="editor" name="newscontent" style="width:1024px;height:500px;margin-left:120px;margin-top:0;"><?php echo ($data['newscontent']); ?></textarea>
                    </li>
                    <li>
